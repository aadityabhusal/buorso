<section>
	<div class="container">
		<form id="edit-container" action="#" method="POST">
			<div id="edit-images">
				<div class="image-container">
					<img src="images/product.png" class="all0" alt="Aaditya Bhusal">
			...
			<div id="edit-info">
				...
				<div>
					<input class="input-short save-button" type="submit" name="saveEdit" value="Save">
